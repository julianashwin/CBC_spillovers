...
nyt_premeeting$recent_meeting <- NA
nyt_postmeeting$subsequent_meeting <- NA
nyt_relevant_meeting <- rbind(nyt_premeeting, nyt_postmeeting)

nyt_prepub$recent_pub <- NA
nyt_postpub$subsequent_pub <- NA
nyt_relevant_pub <- rbind(nyt_prepub, nyt_postpub)

nyt_relevant_pub$recent_meeting <- NA
nyt_relevant_pub$subsequent_meeting <- NA
nyt_relevant_meeting$recent_pub <- NA
nyt_relevant_meeting$subsequent_pub <- NA
nyt_relevant <- rbind(nyt_relevant_meeting, nyt_relevant_pub)
